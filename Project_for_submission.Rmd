...
When the data is replotted excluding more recent years. An overall difference can be seen between summer months and winter months.(fig3,fig4,fig5,fig6)
...
So could this data still be right and valid?(fig7)
A good thing to do would be to look over some smaller sections. The months of January and July were chosen to be plotted to see if there were any obvious differences between the way a plot of all shootings vs a plot of just a small slice of time would look.(fig8,fig9,fig10,fig11)
